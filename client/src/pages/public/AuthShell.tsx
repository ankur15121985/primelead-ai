      ...
      <div className="hidden flex-col justify-between border-r bg-slate-950 p-10 lg:flex">
        <div>
          <span className="flex items-center gap-2">
            ...
            <span className="text-lg font-extrabold text-white">LeadFlow <span className="text-primary">AI</span></span>
          </span>
      ...
      <div className="flex items-center justify-center px-4 py-12 sm:px-8">
        <div className="w-full max-w-md animate-fade-in">
          <Link to="/" className="mb-8 flex items-center gap-2 lg:hidden">
            ...
            <span className="text-lg font-extrabold">LeadFlow <span className="text-primary">AI</span></span>
          </Link>
          {children}
        </div>
      </div>
